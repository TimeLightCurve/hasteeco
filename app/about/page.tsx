...
export const metadata: Metadata = {
  title: "درباره ما | هستیکو",
  description: "با رویکرد، تجربه و ارزش‌های مجموعه املاک و معماری هستیکو آشنا شوید.",
}
    ...
    <main dir="rtl" className="bg-[#f4f2ed] text-brand-dark">
      <section className="relative min-h-screen overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 mx-auto flex min-h-screen max-w-[1600px] flex-col justify-end px-6 pb-16 pt-36 sm:px-10 lg:px-16 lg:pb-20">
          ...
          <h1 className="max-w-5xl text-5xl font-black leading-tight sm:text-6xl lg:text-7xl">فضاهایی برای<br />زندگی بهتر</h1>
          <div className="mt-10 grid max-w-4xl gap-6 border-t border-white/25 pt-6 sm:grid-cols-[1fr_2fr]">
            ...
            <p className="max-w-2xl text-2xl leading-8 text-white/75">هستیکو نقطه تلاقی شناخت بازار ملک، معماری معاصر و تجربه انسانی است. ما کمک می‌کنیم انتخاب یک خانه یا سرمایه‌گذاری، به تصمیمی روشن و مطمئن تبدیل شود.</p>
          </div>
        </div>
      </section>
      ...
      <section className="mx-auto grid max-w-[1500px] gap-12 px-6 py-24 sm:px-10 lg:grid-cols-2 lg:px-16 lg:py-32">
        <div className="relative min-h-[520px] overflow-hidden rounded-[2rem]">
          <Image src="/images/properties/villa-130-interior.jpg" alt="فضای داخلی یکی از پروژه‌های هستیکو" fill className="object-cover" />
          <div className="absolute bottom-0 left-0 bg-black p-7 text-white sm:p-9">
            <strong className="text-4xl font-black">+۱۰</strong>
        ...
        <div className="flex flex-col justify-center lg:pr-10">
          ...
          <h2 className="mt-5 text-4xl font-black leading-tight sm:text-5xl">ملک خوب، آغاز یک داستان ماندگار است.</h2>
      ...
      <section className="bg-brand-dark px-6 py-24 text-white sm:px-10 lg:px-16 lg:py-32">
        <div className="mx-auto max-w-[1500px]">
          <div className="flex flex-col justify-between gap-6 border-b border-white/15 pb-10 sm:flex-row sm:items-end">
            <div><p className="text-base font-bold tracking-[0.22em] text-brand-gold">ارزش‌های ما</p><h2 className="mt-4 text-4xl font-black sm:text-5xl">آنچه به آن پایبندیم</h2></div>
      ...
      <section className="px-6 py-24 sm:px-10 lg:px-16 lg:py-32">
        <div className="mx-auto flex max-w-[1500px] flex-col items-start justify-between gap-8 rounded-[2rem] bg-brand-gold p-8 text-white sm:p-12 lg:flex-row lg:items-end lg:p-16">
          <div><p className="text-base font-bold tracking-[0.2em] text-white/65">شروع یک همکاری</p><h2 className="mt-4 max-w-3xl text-4xl font-black leading-tight sm:text-5xl">برای انتخاب بعدی شما آماده‌ایم.</h2></div>
